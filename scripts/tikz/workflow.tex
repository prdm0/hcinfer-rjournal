...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  \node[hccore] (vcovhc) at (3.0,4.2) {vcov\_hc()};

  \node[hccore] (hcinferfun) at (3.0,1.4) {hcinfer()};

  \node[hccore] (bootpairs) at (3.0,-1.4) {boot\_pairs()};

  \node[hccore] (glsmult) at (3.0,-4.2) {gls\_mult()};

  \node[hccard, draw=hcobject, fill=hcobjectfill] (covcard) at (8.4,4.2) {%
  ...
  \node[hccard, draw=hcobject, fill=hcobjectfill] (infercard) at (8.4,1.4) {%
  ...
  \node[hccard, draw=hcobject, fill=hcobjectfill] (bootcard) at (8.4,-1.4) {%
  ...
  \node[hccard, draw=hcobject, fill=hcobjectfill] (glscard) at (8.4,-4.2) {%
  ...
  \draw[hcedge] (fit.east) -- (bootpairs.west);
  \draw[hcedge] (fit.east) -- (glsmult.west);
  \coordinate (calllower) at ($(fit.west)+(-0.55,1.4)$);
  \coordinate (callupper) at ($(fit.west)+(-0.55,4.2)$);
