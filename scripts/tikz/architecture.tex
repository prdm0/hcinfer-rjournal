...
\begin{tikzpicture}[x=1cm,y=0.92cm]
  \node[hcentry, minimum width=34mm] (fit) at (0,7.1) {stats::lm() fit};

  \node[hccard, draw=hcapi, fill=hcapifill, text width=64mm, font=\scriptsize\sffamily, inner xsep=7pt, inner ysep=6pt] (api) at (0,5.75) {%%
  ...
  \node[hccard, draw=hccorecol, fill=hccorefill, text width=64mm, font=\scriptsize\sffamily, inner xsep=7pt, inner ysep=6pt] (core) at (0,3.15) {%%
  ...
  \node[hccard, draw=hcobject, fill=hcobjectfill, text width=64mm, font=\scriptsize\sffamily, inner xsep=7pt, inner ysep=6pt] (objects) at (0,0.55) {%%
  ...
  \draw[hcsplit] (-3.25,-1.02) -- node[hclabel, fill=hcpage, inner xsep=4pt, inner ysep=1pt] {Supporting infrastructure} (3.25,-1.02);

  \node[hccard, draw=hcsupport, fill=hcsupportfill, text width=29mm, font=\scriptsize\sffamily, inner xsep=6pt, inner ysep=5pt] (support) at (-2.15,-2.05) {%%
    \textbf{Support files}\\
    validation\\
    method metadata\\
    output helpers
  ...
  \node[hccard, draw=hcsupport, fill=hcsupportfill, text width=29mm, font=\scriptsize\sffamily, inner xsep=6pt, inner ysep=5pt] (assets) at (2.15,-2.05) {%%
